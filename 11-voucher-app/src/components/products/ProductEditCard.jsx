...
import ProductEditSkeletonLoader from "../../pages/products/ProductEditSkeletonLoader";
tailspin.register();
          ...
          <div className="flex items-center">
            <input
              ...
              className={`w-4 h-4 ${
                errors.all_correct
                  ? "ring-2 ring-red-500"
                  : "text-blue-600 active:ring-2 active:ring-blue-500"
              } bg-gray-100 border-gray-300 rounded dark:active:ring-blue-600 dark:ring-offset-gray-800  dark:bg-gray-700 dark:border-gray-600`}
            />
            <label
              htmlFor="all_correct"
